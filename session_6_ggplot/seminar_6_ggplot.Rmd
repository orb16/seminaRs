...
```{r, fig.margin = TRUE, fig.cap = "Brachy abundance by water content", cache = TRUE}
...
```{r, fig.margin = TRUE, fig.cap = "Substrate density against water content",cache = TRUE}
...
```{r, fig.margin = TRUE, fig.cap = "Using a plainer background",cache = TRUE, tidy=FALSE}
...
```{r, fig.margin = TRUE, fig.cap = "Notched boxplot",cache = TRUE, tidy=FALSE}
...
```{r, fig.margin = TRUE, fig.cap = "geom\\_abline()",tidy = FALSE, cache = TRUE}
...
```{r, fig.margin = TRUE, fig.cap = "specifying shape \\& colour",tidy = FALSE, cache = TRUE}
miteplot1 + 
...
```{r, fig.margin = TRUE, fig.cap = "Specifying colours; legend position", cache = TRUE, tidy = FALSE}
miteplot1 +
...
```{r, fig.margin = TRUE, fig.cap = "Adding a regression line", cache = TRUE, tidy = FALSE}
miteplot1 + 
  geom_point(aes(colour = Topo))+ 
...
```{r, fig.margin = TRUE, fig.cap = "Facet wrap, scale\\_shape",cache = TRUE, tidy=FALSE}
...
```{r, fig.margin = TRUE, fig.cap = "Facet grid, scale\\_shape",cache = TRUE, tidy=FALSE}
ggplot(mite_all, aes(y = Brachy, x = SubsDens)) +
  geom_point(aes(shape = Topo)) +
  geom_smooth(aes(linetype = Topo), 
              colour = "black", 
...
```{r, fig.margin = TRUE, fig.cap = "Flipped bar chart",cache = TRUE, tidy=FALSE}
...
```{r,fig.margin = TRUE, fig.cap = "Bar chart with SE, 1",cache = TRUE, tidy=FALSE}
...
```{r, fig.width = 10, fig.height = 3, fig.fullwidth = TRUE, fig.cap = "Bar chart with SE, 2", cache = TRUE, tidy=FALSE}
ggplot(mite_summarised, aes(x = Topo, y = mean_count))+
...
````{r, results = 'hide', cache = TRUE, tidy=FALSE}
...
```{r, fig.width = 10, fig.height = 3, fig.fullwidth = TRUE, fig.cap = "Tidy chart", cache = TRUE, tidy=FALSE}
...
```{r, tidy=FALSE, fig.width = 10, fig.height = 3, fig.fullwidth = TRUE, fig.cap = "please don't use", cache = TRUE,}

...
---
# Mapping, animals and corr plots (2)
...
```{r, message=FALSE, cache=FALSE,cache.comments=FALSE}
map('nz')
# or:
nzmap <- map_data('nz')
head(nzmap)
...
url_kakariki <- getURL("https://raw.githubusercontent.com/orb16/seminaRs/master/Ashburton%20lakes.csv", ssl.verifypeer = FALSE)
...
url_ramsar <- getURL("https://raw.githubusercontent.com/orb16/seminaRs/master/Ramsar%20sites.csv", ssl.verifypeer = FALSE)
...
This is going to save your map as "foo.png" to whichever working directory you have (NB, it will likely be where you've saved this .Rmd file, unless you set it explicitly.)

```{r Adding points to a map with base graphics}
...
class(tramping2)
str(tramping2@data)
attributes(tramping2)
attributes(tramping2)
tramping2@polygons[1]

---
title: 'ggplot2 seminar: the extras'
author: "Olivia Burge"
date: "11 October 2014"
output: html_document
---

# Mapping, animals and corr plots (1)  
...
```{r, include=FALSE}
#Some code for text searching: I've found it easier just to go look at the website.


# searchres <- search_text(text = "Stenella", options = "names")
# head(searchres)
# output <- search_images(uuid=searchres[[2]], options=c("pngFiles", "credit", "canonicalName"))
# head(output)
# myobjs <- get_image(output, size = "512")
...
#Solved by calling grid everytime!
...
#dataframe of species scoes for plotting

...
```
Note this plots a similar standard error to that obtained by `se.fit=TRUE, type = "response"`, in that the confidence interval goes below zero which is unrealistic for count data.  You need to use the `rescale = FALSE` option to avoid this.
